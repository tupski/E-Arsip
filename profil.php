...
if(!isset($_SESSION['admin'])){
    ...
    if(isset($_REQUEST['submit'])){
        ...
        if(!empty($_REQUEST['password'])){
            ...
            $query = mysqli_query($config, "UPDATE tbl_user SET username='$username', password='$password', nama='$nama', nip='$nip' WHERE id_user='$id_user'");
        } else {
            $query = mysqli_query($config, "UPDATE tbl_user SET username='$username', nama='$nama', nip='$nip' WHERE id_user='$id_user'");
        }

        if($query == true){
            $_SESSION['succEdit'] = 'SUKSES! Data profil berhasil diupdate';
            echo '<script>alert("SUKSES! Data profil berhasil diupdate"); window.location.href="?page=profil";</script>';
            die();
        } else {
        ...
        <div class="form-container">
            <div class="form-card">
                <div class="form-header">
                    <h1><i class="material-icons">account_circle</i> PROFIL PENGGUNA</h1>
                </div>
                ...
                <div class="form-body">
                    ...
                    <form method="post" action="?page=profil">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <label for="level"><i class="material-icons icon-prefix">verified_user</i> Level User</label>
                                <input type="text" id="level" class="form-control" value="<?php echo ($data['admin'] == 1) ? 'Administrator' : 'User Biasa'; ?>" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            ...
                            <a href="?page=profil" class="btn btn-danger">
